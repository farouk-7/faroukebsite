      ...
      <div className="py-5 px-6 md:px-50">
        ...
        <div className="flex flex-col items-center mt-5 justify-center md:flex-row md:justify-between md:items-start md:mt-10">
          <div>
            ...
            <div className="hidden md:block border-1 w-fit border-[#c2c2c2] p-5 rounded-full mt-10">
        ...
        <div className="flex flex-col  py-5 md:py-0 gap-5 md:gap-0 md:flex-row justify-between items-center border-1 border-[#c2c2c2] mt-5 px-10">
          <div className="flex flex-col items-center">
            <p className="text-5xl font-semibold">5M+</p>
            <p className="font-semibold text-[#464545] pt-3">SUCCESS PROJECT</p>
          </div>

          <div className="hidden md:block h-50 w-[1px] mx-10 bg-[#c2c2c2]"></div>
        ...
        <section id="projects" className="mt-20 items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            />
            <Card
              title={"Cosmos Remit Website"}
              description={
                "Cosmos Remit is a platform where you bget to send money across coutries with ease. It offers low charges transaction and safety of the money using our escrow services"
              }
              image={"/cosmos.png"}
              technologies={["React", "Chakra", "AOS"]}
              demoUrl={"https://cosmos-remits.vercel.app/"}
              // githubUrl={
              //   "https://github.com/Zillight-Innovation-Labs/leadcapital-website.git"
              // }
            />
        ...
        <section id="services" className="mt-20 items-center justify-center">
